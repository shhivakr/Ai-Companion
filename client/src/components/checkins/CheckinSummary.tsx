  ...
  return (
    <Card className="p-5">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-3">
        <div>
          <p className="text-xs text-foreground-secondary">Feeling</p>
          <p className="mt-1 text-sm font-medium">{feeling}</p>
        </div>

        <div>
          <p className="text-xs text-foreground-secondary">Energy</p>
          <p className="mt-1 text-sm font-medium">{energy}</p>
        </div>

        <div>
          <p className="text-xs text-foreground-secondary">Focus</p>
